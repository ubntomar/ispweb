...
// $periodo=$mes[12];// hoy 02   de DICIEMBRE de 2021 aquí pongo el mes al que le voy a crear la tanda de facturas a todos los afiliados.  AND `suspender`!=1
// $cont=0;																
...
// 				$saldo=$valorf;
// 			}
// 			$sql1 = "INSERT INTO `redesagi_facturacion`.`factura` (`id-factura`, `id-afiliado`, `fecha-pago`, `iva`, `notas`, `descuento`, `valorf`, `valorp`, `saldo`, `cerrado`, `fecha-cierre`, `vencidos`, `periodo`) VALUES (NULL,'$idafiliado', '$fechaPago', '19', '$notas', '0', '$valorf', '$valorp', '$saldo', '$cerrado', '$fechaCierre', '-10', '$periodo');";
// 			echo "<br>".$sql1."<br>";
// 			//$mysqli->query($sql1);      
// 		}else{
// 			$standby-=1;
