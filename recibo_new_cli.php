...
<table style="table-layout:fixed;font-size:11px;" width="200" border="0">
  ...
  <tr>
    <td class="col1f2"></td>
    <td class="col2f2"></td>
    <td class="col3f2"><?php echo"$hoy";?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;www.redesagingenieria.com   ag.ingenieria.wist@gmail.com  </td>
    <td class="col4f2"></td>
    <td class="col5f2"></td>
    <td class="col6f2"></td>
    <td class="col7f2"></td>
  ...
  <tr>
    <td class="col1f5"></td>
    <td class="col2f5"></td>
    <td  colspan="2"class="col3f5" style="text-align:left;font-size:10px;"><?php echo "$direccion  - Telefono:$telefono";?></td>
  ...
  <tr valign="bottom">
    ...
    <td style="font-size:10px;text-align:left;" class="col5f6">$<?php echo number_format($valorAfiliacion,0);?></td>
    <td class="col6f6"></td>
    <td style="text-align:right;font-size:10px;" class="col7f6">$<?php echo number_format($valorAfiliacion,0);?></td>
    <td class="col8f6"></td>
  </tr>
  <tr valign="top">
    <td class="col1f7" style="text-align:left;font-size:10px;"  ></td>
    <td class="col2f7"></td>
    <td  colspan="2" class="col3f7" style="font-size:10px;text-align:left;font-style:bold;">Los equipos instalados son propiedad de la empresa,se recogen si mora mayor 2 meses.</td>
  ...
  <tr>
    ...
    <td style="text-align:right;font-size:12px;font-weight: bold;" class="col7f9">$<?php echo number_format($valorAfiliacion,0);?></td>
    <td class="col8f9"></td>
  </tr>  
</table>
<table style="table-layout:fixed;font-size:11px;" width="200" border="0">
  ...
  <tr>
    <td class="col1f7" style="text-align:left;font-size:10px;"  ></td>
    <td class="col2f7"></td>
    <td  colspan="2" class="col3f7" style="font-size:10px;text-align:left;">Los equipos instalados son propiedad de la empresa,se recogen si mora es mayor 2 meses.</td>
  ...
  <tr>
    ...
    <td class="col3f8"></td>
    <td colspan="4" style="text-align:left;font-size:12px;" class="col4f8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Acepto condiciones de servicio:</td>
