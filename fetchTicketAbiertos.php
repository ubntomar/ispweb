...
$hourMin = date('H:i');
$queryPart="";
$sqlSearch="SELECT * FROM `redesagi_facturacion`.`ticket` WHERE  `status` LIKE 'ABIERTO' ORDER BY `id` DESC   limit 20";  
