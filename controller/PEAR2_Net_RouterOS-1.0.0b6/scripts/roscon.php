...
if (!class_exists('Phar', false) || !Phar::running()) {
    $dataDirPaths[] = '@PEAR2_DATA_DIR@/pear2.php.net/PEAR2_Net_RouterOS';
    if (($pearDataDir = getenv('PHP_PEAR_DATA_DIR'))) {
        $dataDirPaths[] = $pearDataDir . '/PEAR2_Net_RouterOS';
    }
    $dataDirPaths[] = '@PEAR2_DATA_DIR@/PEAR2_Net_RouterOS';
}
$dataDirPaths[] = __DIR__ . '/../data/pear2.php.net/PEAR2_Net_RouterOS';
$dataDirPaths[] = __DIR__ . '/../data/PEAR2_Net_RouterOS';
